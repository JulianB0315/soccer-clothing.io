...
<html lang="en">
    <head>
        ...
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KyZXEAg3QhqLMpG8r+8fhAXLRP8YB1AC1sn+OAAdhb/I1mfxIp4Hy7jw/DvvuObC" crossorigin="anonymous">
            ...
            <main>
                ...
                <div class="container-xl px-4 mt-4">
                    ...
                    <nav class="nav nav-borders">
                        ...
                        <a class="nav-link" href="account-billing.html">Historial</a>
                    </nav>
                    <hr class="mt-0 mb-4" />
                    <div class="row">
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-4 mb-xl-0">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <button class="btn btn-primary" type="button">Sube una imagen</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-8">
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="inputUsername" type="text" placeholder="Ingresa tu nombre de usuario" value="" />
                                        </div>
                                        <!-- Form Row-->
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="inputFirstName" type="text" placeholder="Ingresa tu nombre" value="" />
                                            </div>
                                            <!-- Form Group (last name)-->
                                            <div class="col-md-6">
                                                <label class="small mb-1" for="inputLastName">Apellido:</label>
                                                <input class="form-control" id="inputLastName" type="text" placeholder="Ingresa tu apellido" value="" />
                                            </div>
                                        </div>
                                        <!-- Form Row        -->
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <!-- <div class="col-md-6">
                                                <label class="small mb-1" for="inputOrgName">Nombre de la Organizacion</label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="inputLocation" type="text" placeholder="Ingresa tu ubicacion" value="" />
                                            </div>
                                        </div>
                                        <!-- Form Group (email address)-->
                                        <div class="mb-3">
                                            <label class="small mb-1" for="inputEmailAddress">Correo Electronico:</label>
                                            <input class="form-control" id="inputEmailAddress" type="email" placeholder="Ingresa tu email" value="" />
                                        </div>
                                        <!-- Form Row-->
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="inputPhone" type="tel" placeholder="Ingresa tu numero" value="" />
                                            </div>
                                            <!-- Form Group (birthday)-->
                                            <div class="col-md-6">
                                                <label class="small mb-1" for="inputBirthday">Fecha de nacimiento:</label>
                                                <input class="form-control" id="inputBirthday" type="text" name="birthday" placeholder="Ingresa tu fecha de nacimiento" value="" />
                                            </div>
                                        </div>
                                        <!-- Save changes button-->
                                        <button class="btn btn-primary me-3" type="button">Editar perfil</button>
