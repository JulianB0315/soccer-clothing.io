...
// La query para jalar los datos del usuario
$query = "SELECT nombres, apellido, email, telefono, direccion FROM clientes WHERE id_cliente = ?";
                        ...
                        <div class="card-body">
                            <form method="post" action="guardar_cambios_user.php">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputUsername" type="text" placeholder="Ingresa tu nombre de usuario" value="" disabled /> <!--Aca iria el apodo del cliente o algo asi (lo debemos agregar en la db))
                                </div>
                                <!-- Form Row-->
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputBirthday" type="text" name="birthday" placeholder="Ingresa tu fecha de nacimiento" value="" disabled /> <!--Aca iria la fecha d nacimiento o el cumple del cliente o algo asi (lo debemos agregar en la db))
                                    </div>
                                </div>
                                <!-- Save changes button-->
